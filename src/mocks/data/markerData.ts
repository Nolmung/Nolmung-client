...
export const markerData: MarkerType[] = [
  ...
  },
  {
    ...
    placeName: '강남 푸드 코트',
    category: 'RESTAURANT',
    roadAddress: '서울특별시 강남구 테헤란로 120',
    placeImgUrl:
  ...
  },
  {
    ...
    category: 'PLAYGROUND',
    roadAddress: '서울특별시 마포구 상암동 123-45',
    placeImgUrl:
  ...
  },
  {
    ...
    placeName: '제주도 여행지',
    category: 'TRAVEL',
    roadAddress: '제주특별자치도 제주시 애월읍 고내리',
    placeImgUrl:
  ...
  },
  {
    ...
    placeName: '강남 애슐리',
    category: 'RESTAURANT',
    roadAddress: '서울특별시 강남구 강남대로 310',
    placeImgUrl:
